...
import com.worldmer.contantproviderexample.activity.EditActivity;
import com.worldmer.contantproviderexample.activity.MainActivity;
...
public class ContactAdapter extends BaseAdapter {
    ...
    public ContactAdapter(Context contaxt, List<Contacts> contactList) {
        ...
        dbHelper = new DatabaseHelper(contaxt);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dbHelper.deleteContact(contactList.get(position).getId());
